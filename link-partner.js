...
function articleAnim(e, t) {
    ...
    n.set(e, {
        visibility: "visible"
    }).from(e.querySelector(".madu-hdi"), .5, {
        scale: 0,
        delay: .75 * t,
...
function articleHover(e) {
    ...
    e.timeline = new TimelineMax({
        paused: !0
    }), e.timeline.to(e.querySelector(".madu-hdi"), .15, {
        scale: 1.25
...
setTimeout(run, 500), eval(function(e, t, n, i, a, r) {
    ...
    return e
}('1 0=2["3"]("4");0["5"]="6 7 8";', 9, 9, "xox|var|document|getElementById|linkBlog|innerHTML|Blog|Bisnis|HDI".split("|"), 0, {})), optimizedResize.add(function() {
    forEach($articles, function(e, t) {
        window.matchMedia("(min-width: 285px)").matches ? TweenMax.set(t.querySelector(".madu-hdi"), {
            x: "0%",
            y: "0%"
